...
<div>
	...
	<HelpSection title="インボイス登録期間と消費税区分">
		<p>
			適格請求書発行事業者（インボイス登録事業者）として年度途中で登録・脱退した場合、消費税集計に影響があります。
		</p>
		<ul class="mt-2 list-disc space-y-1 pl-6">
			<li>事業者情報でインボイス登録番号と<strong>登録適用開始日・終了日</strong>を設定できます</li>
			<li>消費税集計ページで、登録期間のステータス（全期間適用/一部期間/期間外）が表示されます</li>
			<li>登録期間外に課税売上の仕訳がある場合、警告が表示されます</li>
		</ul>
		<HelpNote type="warning">
			年度途中でインボイス登録した場合、登録前の売上には消費税を請求できません。登録期間外の売上の消費税区分が正しいか確認してください。
		</HelpNote>
	</HelpSection>
