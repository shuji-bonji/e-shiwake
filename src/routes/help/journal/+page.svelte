...
<div>
	...
	<HelpSection title="家事按分">
		<p>
			...
			対象の勘定科目を入力すると、自動的に按分パネルが表示されます。
		</p>
		...
		<ol class="ml-4 list-decimal space-y-2">
			<li>按分対象の勘定科目を借方に入力すると、按分パネルが表示されます</li>
			<li>事業割合を調整できます（0〜100%）</li>
			<li>「按分適用」ボタンをクリックすると、自動的に事業主貸の行が追加されます</li>
		</ol>
		...
		<HelpNote type="info">
			<p>
				按分を解除したい場合は、按分パネルの「按分解除」ボタンをクリックすると、
				元の金額に戻り、事業主貸の行が削除されます。
			</p>
		</HelpNote>
	</HelpSection>
